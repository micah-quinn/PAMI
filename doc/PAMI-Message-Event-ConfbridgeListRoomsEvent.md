PAMI\Message\Event\ConfbridgeListRoomsEvent
===============

Event triggered when an action ConfbridgeListRooms action is issued.

PHP Version 5


* Class name: ConfbridgeListRoomsEvent
...
### getMarked
    ...
    string PAMI\Message\Event\ConfbridgeListEvent::getMarked()
...
### getLocked
    ...
    string PAMI\Message\Event\ConfbridgeListEvent::getLocked()
